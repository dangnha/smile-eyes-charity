...
const contactForm = (props) => {
    return(
        ...
        <div class="container mx-auto my-20 w-1/3 border border-white bg-green-600   h-[679px]">
          ...
          <p class=" text-white text-sm font-medium font-['Inter']">Please become a part of us, join hands in building a loving community.
                    ...
                    <div class="grid grid-cols-2 gap-5 ">
                        <textarea
                         cols="10"
                         rows="5"
                         class="text-white border border-blue-gray-200 border-t-transparent bg-transparent px-3 py-2.5 font-sans text-sm font-normal text-blue-gray-700 outline outline-0 transition-all placeholder-shown:border placeholder-shown:border-blue-gray-200 placeholder-shown:border-t-blue-gray-200 focus:border-2 focus:border-pink-500 focus:border-t-transparent focus:outline-0 disabled:resize-none disabled:border-0 disabled:bg-blue-gray-50 col-span-2"
                         placeholder="Write your message..."></textarea>
                         <input
                         class=" text-white peer h-full w-full rounded-[7px] border border-white border-t-transparent bg-transparent px-3 py-2.5 font-sans text-sm font-normal text-blue-gray-700 outline outline-0 transition-all placeholder-shown:border placeholder-shown:border-blue-gray-200 placeholder-shown:border-t-white focus:border-2 focus:border-pink-500 focus:border-t-transparent focus:outline-0 disabled:border-0 disabled:bg-blue-gray-50"
                         placeholder="Name "
                       />
                       <input
                         class=" text-white peer h-full w-full rounded-[7px] border border-white border-t-transparent bg-transparent px-3 py-2.5 font-sans text-sm font-normal text-blue-gray-700 outline outline-0 transition-all placeholder-shown:border placeholder-shown:border-blue-gray-200 placeholder-shown:border-t-white focus:border-2 focus:border-pink-500 focus:border-t-transparent focus:outline-0 disabled:border-0 disabled:bg-blue-gray-50"
                ...
                <button class=" place-items-end  px-2 py-2 bg-white">Join Now</button>
        </div>
      </div>
    )
}
