...
const Footer = ({
  ...
  return (
    <div className="footer">
      ...
      <img className="line-7" alt="Line" src="./images/Line27.svg" />
      <div className="overlap-wrapper">
        <div className="overlap">
          <div className="group-3">
            <div className="QA-contact">QA & Contact</div>
            <div className="text-wrapper-10">Project</div>
            <img className="line-8" alt="Line" src="./images/Line29.svg" />
          </div>
          <div className="group-4">
            <div className="text-wrapper-10">Contributor</div>
            <img className="line-9" alt="Line" src="./images/Line29.svg" />
          </div>
          <div className="group-5">
            <div className="text-wrapper-10">Blogs</div>
            <img className="line-10" alt="Line" src="./images/Line29.svg" />
          </div>
          <div className="group-6">
            <div className="text-wrapper-10">Achievement</div>
            <img className="line-11" alt="Line" src="./images/Line29.svg" />
          </div>
          <div className="group-7">
            <div className="text-wrapper-10">Activities</div>
            <img className="line-12" alt="Line" src="./images/Line29.svg" />
          </div>
        </div>
      </div>
    </div>
