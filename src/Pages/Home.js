  ...
  return (
    <div>
      <div className="content">
        ...
        <LargeProgramItem title={video_introduce.title} date={video_introduce.date} linkYT={video_introduce.linkYT} des={video_introduce.des} amoutOfLikes={video_introduce.amoutOfLikes}/>
      </div>

      <div className="project_calling">
        <div className="title_button">
          <p id="title_project">Programs which are calling for volunteers and sponsors</p>
          <div id="button_see_all"><Button text="See all"/></div>
        </div>

        <div className="project">
        {projects.map((project) => (
              <div id="item_project"><ProgramItem title={project.title} date={project.date} linkYT={project.linkYT} des={project.des} amoutOfLikes={project.amoutOfLikes}/></div>
        ))}
        </div>
      </div>
      ...
      <div className="project_done">
        ...
        <div className="project">
          {projects_done.map((project_done) => (
                <div id="item_project"><ProjectDone title={project_done.title} date={project_done.date} linkYT={project_done.linkYT} des={project_done.des} amoutOfLikes={project_done.amoutOfLikes} cost={project_done.cost}/></div>
          ))}
        </div>
      </div>
      </div>
        ...
        <div className="blog_content">
          <div className="blog_image">
            <div className="blog_image1">
              <div className="image1"><img className="img-fit" src="../image/1.jpg" alt="Not found"/></div>
              <div className="image1"><img className="img-fit" src="../image/tre-em.jpg" alt="Not found"/></div>
            </div>
            <div className="blog_image2"><img className="img-fit" src="../image/chum-anh-nhung-doi-mat-nu-cuoi-rat-trong-cua-cac-em-be-vung-cao.webp" alt="Not found"/></div>
          </div>
          <div className="blog_des">
            <i class="fa-solid fa-quote-left fa-2xl mr-auto"></i>
            <p className="des_title_blog mt-5">We provide opportunity support for children living in the highlands, mountains and disadvantaged areas in Nam Giang. Our main goal is to improve the quality of life of children so that they develop comprehensively physically, mentally and educationally.</p>
      ...
      <div className="profile flex flex-row items-center">
        <div className="profile_des">
          ...
          We provide opportunity support for children living in the highlands, mountains and disadvantaged areas in Nam Giang. Our main goal is to improve the quality of life of children so that they develop comprehensively physically, mentally and educationally.
          </p>
          <i class="fa-solid fa-quote-right fa-2xl ml-auto mt-5"></i>
        </div>

        <div className="profile_intro">
            <img className="image_profile mx-auto" src="../image/168730.png" alt=""></img>
            <div className="mt-5">
              ...
              <p className="profile_intro_text2">Email: dinhdongphuong@gmail.com</p>
            </div>
        </div>
      </div>
      ...
      <div className="who_we_are flex flex-row">
        <div className="our_information">
            ...
            <p className="our_information_heading3">We provide opportunity support for children living in the highlands, mountains and disadvantaged areas in Nam Giang. Our main goal is to improve the quality of life of children so that they develop comprehensively physically, mentally and educationally.</p>
