    ...
    <div>
      <div className="w-[100vw] h-[70vh] flex">
        <div className="w-full h-full bg-[#F6FFF6] flex justify-center items-center">
          <div className=" flex flex-col justify-center items-start gap-[60px] w-[60%] h-[90%]">
            <div className="text-4xl text-left font-serif">
              Improve the quality of life, comprehensive mental and educational
              development for children in Nam Giang
            </div>
            <Link to="/programs">
              <Button text="Our Projects" className="text-4xl" />
            </Link>
          </div>
        </div>
      ...
      <div className="flex flex-col items-center w-[95%] mx-auto">
        ...
        <div className="text-xl text-center flex gap-5">
          ...
          We feel very appreciated and grateful for your sponsorship. Thank you
          for <br /> contributing to building our organization further.
        ...
        <div className="py-[100px]">
          <div className="flex flex-col justify-center gap-16 pb-[80px]">
            <div className="flex flex-col items-center">
              ...
              <div className="text-3xl italic pt-3">Gold Sponsor</div>
            </div>
